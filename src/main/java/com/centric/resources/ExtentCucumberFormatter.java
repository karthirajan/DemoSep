...
public class ExtentCucumberFormatter implements Reporter, Formatter {
	...
	public static void setExtentHtmlReport(File file) throws IOException {
...
private static ExtentXReporter getExtentXReporter() {
        ...
        ExtentXReporter extentx = new ExtentXReporter("183.82.248.55", 27017);
        ...
        extentx.config().setServerUrl("http://183.82.248.55:1337");
